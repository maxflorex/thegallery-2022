...
const ModalMenu = ({ handleClick }) => {
    ...
    return (
        <div
            className="absolute w-[40rem] h-[100vh] top-0 right-0 bg-off-1/90 backdrop-blur-sm dismiss"
            onClick={handleClick}
        >
            ...
            <span
                className="fixed top-8 right-8 px-4 py-4 bg-off-1 rounded-full hover:bg-pink-500 cursor-pointer dismiss duration-700 transition-all dismiss"
                onClick={handleClick}
            >
                <svg
